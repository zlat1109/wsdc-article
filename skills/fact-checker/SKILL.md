...
metadata:
  origin: seaworld008/Commonly-used-high-value-skills (Cursor install)
---
...
For web verification, use **duckduckgo-search** MCP (or fetch official docs). Cite sources in the correction report. Do not assert claims without search evidence.
